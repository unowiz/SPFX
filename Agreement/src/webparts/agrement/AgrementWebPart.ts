...
import { IAgrementProps } from './components/IAgrementProps';
import ContentDataProvider from '../../dataprovider/contentDataProvider';

export interface IAgrementWebPartProps {
  headertext: string;
  linktitle1: string;
  linktext1: string;
  linkurl1: string;
...
export default class AgrementWebPart extends BaseClientSideWebPart<IAgrementWebPartProps> {
  ...
  public render(): void {
    ...
    const element: React.ReactElement<IAgrementProps > = React.createElement(
      Agrement,
      {
