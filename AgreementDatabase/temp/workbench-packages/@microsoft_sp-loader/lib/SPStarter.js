...
var SPStarter = (function () {
    ...
    SPStarter.start = function (preloadedData, handleFailure, debugData) {
        ...
        var unloadKillswitch = Guid.parse('3a9dee33-c9a3-47be-a6d7-39416dafa93c');
        try {
            ...
            if (_SPKillSwitch.isActivated(unloadKillswitch, '2018/06/11', 'Unload components when using debug loader')) {
