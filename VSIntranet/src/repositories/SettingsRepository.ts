...
export class SettingsRepository { 
     ...
     * @param countryName The name of the country as specified in the Country Sites list in the global site collection.
     * @returns The url for the country.
     */
    private async getCountryUrl(countryName: string): Promise<string> {
        const provider = new SPListConfigurationProvider(this.rootWeb, "Country Sites");
